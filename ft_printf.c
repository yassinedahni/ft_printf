...
/*   Updated: 2021/11/27 03:52:01 by ydahni           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int f(const char s ,va_list str)
{
    if (s == 'd' || s == 'i')
        ...
        return (ft_puthexa(va_arg(str, int)));
    else if (s == 'X')
        return (ft_puthexax(va_arg(str, int)));
	else if (s == 'p')
